...
Terraform prints the static IPv4 and an SSH command. The first boot installs Docker and prepares `/opt/managed-oss` for application data, configuration, and backups.
